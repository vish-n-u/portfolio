...
const Portfolio = () => {
    ...
    projects: [
      {
        ...
        image: "https://via.placeholder.com/400x300/6366f1/ffffff?text=Notera+App",
        tech: [
          "Android Studio",
          "Kotlin",
          "Jetpack Compose",
      ...
      },
      {
        ...
        image: "https://via.placeholder.com/400x300/8b5cf6/ffffff?text=Excel+Clone",
      ...
      },
      {
        ...
        image: "https://via.placeholder.com/400x300/06b6d4/ffffff?text=Swiggy+Clone",
        tech: [
          "React",
          "Redux",
          "Express",
    ...
    experience: [
      {
        ...
        description: "Assisted with development of 'VidyBack', integrating new features with React to meet user needs and market trends. Built and optimized RESTful APIs and Firebase for real-time data sync and storage. Enhanced performance through bug fixes, load time improvements, and component optimization. Collaborated on modern UI/UX, integrated OpenAI for intelligent content generation, and mentored interns to uphold development quality.",
      },
      {
        company: "Toriox OPC",
        position: "Intern",
        duration: "2023 - 2024",
        description: "Collaborated with the team to design and launch a user-friendly website using Next.js. Assisted in debugging and improving software functionality alongside senior developers.",
      },
    ]
  };
  ...
  // Improved theme classes with better contrast
  const themeClasses = {
    bg: isDarkMode
      ? "bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900"
      : "bg-gradient-to-br from-blue-50 via-white to-purple-50",
    text: isDarkMode ? "text-gray-100" : "text-gray-900", // Improved contrast
    textSecondary: isDarkMode ? "text-gray-200" : "text-gray-700", // Better contrast
    textMuted: isDarkMode ? "text-gray-300" : "text-gray-600", // More readable
    card: isDarkMode
    ...
    buttonOutline: isDarkMode
      ? "border-blue-400 hover:bg-blue-400/10 text-blue-300 hover:text-blue-200"
      : "border-blue-600 hover:bg-blue-600/10 text-blue-700 hover:text-blue-800",
  };
  ...
  return (
    <div className={`min-h-screen transition-all duration-500 ${themeClasses.bg} ${themeClasses.text}`}>
                ...
                <button
                  ...
                  className={`capitalize transition-colors font-medium ${
                    activeSection === item
                      ...
                      : `${themeClasses.textSecondary} hover:text-blue-400`
                  }`}
                >
                  {item}
                </button>
            ...
            <div className="px-2 pt-2 pb-3 space-y-1">
              {["home", "about", "projects", "experience", "contact"].map((item) => (
                <button
                  key={item}
                  onClick={() => scrollToSection(item)}
                  className={`block px-3 py-2 text-base font-medium capitalize w-full text-left transition-colors ${
                    activeSection === item
                      ? "text-blue-400 font-semibold"
                      : `${themeClasses.textSecondary} hover:text-blue-400`
                  }`}
        ...
        <div className="text-center z-10 max-w-4xl mx-auto px-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
            ...
            <button
              ...
              className={`px-8 py-4 ${themeClasses.card} rounded-full transition-all duration-300 hover:scale-105 border flex items-center space-x-2 font-semibold`}
            >
              <Download size={18} />
              <span>Resume</span>
            </button>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4">
                  {portfolioData.skills.map((skill, index) => (
                    <div
                      ...
                      } rounded-xl px-4 py-3 text-sm text-center border hover:border-blue-400/50 transition-all duration-300 transform hover:scale-105 hover:shadow-lg font-medium`}
                    >
                      {skill}
                    </div>
                  ))}
            ...
            <div className="space-y-8">
              ...
              <p className={`text-xl leading-relaxed ${themeClasses.textSecondary}`}>
                When I'm not pushing the boundaries of what's possible on the web, 
                you'll find me experimenting with new technologies, building apps I 
                think can solve niche real life problems.
              </p>
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex flex-wrap gap-3 mb-6">
                      {project.tech.map((tech, index) => (
                        <span
                          key={index}
                          className={`bg-gradient-to-r from-blue-500/20 to-purple-500/20 px-4 py-2 rounded-full text-sm border border-blue-500/30 font-medium ${isDarkMode?"text-black":"text-black"}`}
                    ...
                    <div className="flex flex-wrap gap-2 mb-4">
                      {project.tech.map((tech, index) => (
                        <span
                          ...
                          className={`bg-blue-500/20  px-2 py-1 rounded-md text-xs border border-blue-500/30 `}
                            style={{ color: "black !important" }}
                        >
                          {tech}
                        </span>
      ...
      {/* Footer */}
      <footer
        className={`py-12 text-center ${themeClasses.textMuted} border-t relative z-10 ${
